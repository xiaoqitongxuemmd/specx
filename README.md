...
- [templates/backend_spec.template.md](/home/mini/Project/PDCL4/specx/templates/backend_spec.template.md)
  - 后端 Spec 模板。
  - 覆盖输入材料分析、边界定义、架构设计、契约、数据模型、状态机、幂等、迁移、可观测性、测试策略等章节。
